...
## Main classes
1. PatternDrawerService - a core class, containing methods - atomic „patterns“, from which any figure can be potentially built.
   Already optimised for building complicated lines.
2. Drawer classes - a higher level abstraction above Pattern class. Used for building actual figures using patterns from Pattern
   class.
   - FigureDrawerService - prints debugging figures (triangles, lines)
   - HouseDrawerService - print an actual house, has 4 methods with different levels of complexity as mentioned above.
